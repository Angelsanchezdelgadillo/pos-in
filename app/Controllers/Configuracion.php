...
class Configuracion extends BaseController
{
    ...
    public function index($activo = 1)
    {
        ...
        $ticket = $this->configuracion->where('nombre','ticket_leyenda')->first();

        $data = ['titulo' => 'Configuracion' ,'nombre' => $nombre , 'rfc' => $rfc , 'telefono' => $telefono , 'email' => $email , 'direccion' => $direccion , 'ticket' => $ticket];
        echo view('header');
